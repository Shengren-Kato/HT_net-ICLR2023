...
train_path = '/dssg/home/acct-nislz/nislz/xubo/swinfno/data/Htrain.mat'
test_path = '/dssg/home/acct-nislz/nislz/xubo/swinfno/data/Htest.mat'
...
R_dic['region'] = [0, 1, 0, 1]  # region [a,b,c,d] means [a,b]*[c,d]

R_dic['subsample_nodes'] = 2  # reslution = data.resolution/subsample_nodes
R_dic['subsample_attn'] = 2  # attention resolution = data.resolution/subsample_attn
...
R_dic['downsample_mode'] = 'patchembed'
R_dic['upsample_mode'] = 'identity'
R_dic['window_size'] = [8, 8, 8]
R_dic['depths'] = [2, 4, 2]
R_dic['num_heads'] = [4, 4, 4]

R_dic['learning_rate'] = 1e-3
R_dic['posadd1'] = False  # If ture, input = node+pos; Else input = node;
R_dic['posadd2'] = True  # If ture, FNO input = node+pos; Else input = node;
R_dic['downtype'] = 'purify'
